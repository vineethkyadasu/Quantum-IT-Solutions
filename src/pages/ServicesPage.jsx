    ...
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <h2 className="mt-4 text-xl md:text-2xl font-semibold text-gray-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={index} className="group">
                <div className="text-3xl md:text-4xl font-bold text-gray-900 group-hover:text-primary-600 transition-colors">
                  {stat.number}
                </div>
